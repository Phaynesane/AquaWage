        ...
        <ul class="nav">
          <li class="nav-item nav-profile">
            <a href="#" class="nav-link">
              ...
              <div class="text-wrapper">
                <p class="profile-name">Reanne Martinez</p>
                <p class="designation">HR Manager</p>
              </div>
            </a>
          </li>
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item">
                  <a class="nav-link" href="pages/ui-features/buttons.html">User Profile</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="pages/ui-features/dropdowns.html">Attendance</a>
                </li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item">
                  <a class="nav-link" href="pages/ui-features/buttons.html">Payments</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="pages/ui-features/dropdowns.html">Deductions</a>
                </li>
                <li class="nav-item">
                ...
                <form action="#">
                  ...
                  <div class="form-group">
                    <button class="btn btn-block g-login">
                      <img class="mr-3" src="" alt="">Log in with Google</button>
                  </div>
                  <div class="text-block text-center my-3">
                    <span class="text-small font-weight-semibold">Not a member ?</span>
                    <a href="register.vue" class="text-black text-small">Create new account</a>
                  </div>
                </form>
              </div>
...
@-webkit-keyframes dropdownAnimation {
  ...
  /* Sidebar */
  .sidebar {
    min-height: calc(200vh - 73px);
    background: linear-gradient(to top, #6062ca, rgb(8, 1, 110));
    font-family: "roboto", sans-serif;
    padding: 0;
    width: 280px;
    z-index: 10;
